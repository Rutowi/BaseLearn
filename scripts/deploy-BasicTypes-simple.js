...
async function main() {
  ...
  await basicTypes.deploymentTransaction()?.wait(2); // Wait for 2 confirmations
  ...
  fs.writeFileSync(
    `${deploymentPath}/BasicTypes-base-sepolia.json`, 
  ...
  console.log(`Deployment info saved to: ${deploymentPath}/BasicTypes-base-sepolia.json`);
  
  console.log("\n🌐 Next steps:");
  console.log("1. Verify contract on BaseScan:");
  console.log(`   npx hardhat verify --network base-sepolia ${basicTypesAddress}`);
